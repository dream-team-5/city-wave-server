...
RSpec.describe Admin::Session, type: :model do
  ...
  describe '#save' do
    context do
      ...
      after { expect(subject.instance_variable_get :@persisted).to eq nil }
    ...
    context do
      ...
      after { expect(subject.instance_variable_get :@persisted).to eq false }
    ...
    context do
      ...
      after { expect(subject.instance_variable_get :@persisted).to eq true }
  ...
  describe '#validate_admin' do
    ...
    context do
      ...
      it do
        expect { subject.send :validate_admin }.to_not change { subject.errors[:username] }
      end
    end
    ...
    context do
      ...
      it { expect { subject.send :validate_admin }.to_not change { subject.errors[:username] } }
    end
    ...
    context do
      ...
      it do
        expect { subject.send :validate_admin }
          .to change { subject.errors[:username] }
          .by [I18n.t('errors.messages.invalid')]
      end
    end
